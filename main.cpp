 ...
 * Author: Ducnt 
 *
 * Created on July 9, 2018, 9:08 AM
 */
...
public:
    ...
    BaseNotification(int data) : m_data(data) {
        std::cout << "call construct BaseNotification " << data << std::endl;
    }
...
public:
    ...
    EachNotification(int data) : BaseNotification(data) {
        std::cout << "call construct EachNotification " << data << std::endl;
    }
};
...
public:
    ...
    MyNotificationQueue() : m_pMsg(NULL) {
    }

    MyNotificationQueue(ScopedLogMessage& msg) : m_pMsg(&msg) {
    }
...
//
//    TestNotificationCenter<Poco::NotificationQueue>(msg, "Poco::NotificationQueue DEMO");
//    
//    
